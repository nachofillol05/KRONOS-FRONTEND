  ...
  return isLoading ? (
    ...
    <>
      <Tabs
        ...
        defaultActiveKey="1"
        style={{ marginInline: "auto", marginTop: "50px" }}
      >
                ...
                >
                  ...
                  >
                    <Input
                      size="large"
                      style={
                        !isEditing ? customDisabledStyle : { height: "40px" }
                      }
                      disabled={!isEditing}
                    />
                  </Form.Item>
        ...
        <Tabs.TabPane tab="Datos del colegio" key="2">
          <Card className="CardProfile" title="Información del Colegio">
            <Form
              form={formSchool}
              layout="vertical"
              style={{ height: "60vh", overflowY: "auto", padding: "25px" }}
                ...
                <Form.Item name="school_picture">
                  ...
                  >
                    ...
                    >
                      <img
                        src={
                          escuelaCompleta || "https://via.placeholder.com/150"
                        }
                        style={{
                          objectFit: "cover",
                          width: "100%",
